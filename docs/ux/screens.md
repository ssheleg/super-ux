...
| SCR-02 | Non-TTY numbered list + prompt | FLW-02 | n/a | built | `bin/super-ux.js:437-445 selectFallback` |
...
**Status:** built
**Used by:** FLW-01
**Coverage:** `bin/super-ux.js:338-399 selectInteractive`
...
**Status:** built
**Used by:** FLW-02
**Coverage:** `bin/super-ux.js:437-445 selectFallback`
...
**Coverage:** `bin/super-ux.js:105-198 installCursor`
