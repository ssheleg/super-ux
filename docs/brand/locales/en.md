...
Locale: en
Primary: yes
Address form: you, direct, no honorific
Length coefficient: 1.00
Humor: base
Never translated: super-ux, sheleg-design, task-pipeline, Claude Code, Cursor, Codex, every flag and file name
Keywords: none — this product does not run keyword research
Reviewed by: ssheleg
